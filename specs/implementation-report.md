...
- `npm run lint` - Pass
- `npm test -- tests/services/HierarchyService.test.ts tests/utils/manualSort.test.ts tests/hooks/listPaneData/listItems.test.ts` -
  Pass, 86 tests
- `npm run build` - Pass
...
Manual Obsidian QA has not been run in this report. Items that require live app confirmation are marked as code/test
verified rather than live verified.
